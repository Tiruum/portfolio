...
export const CustomCursor: React.FC = () => {
	...
	useEffect(() => {
		const moveCursor = (e: MouseEvent) => {
			...
			setTimeout(() => {
				// Simulate a delay for the outer circle
	...
	const outerSize = isClicking ? 30 : isHovering ? 50 : 40;
	const innerSize = 10;

	return (
		<div>
			<div
				className="cursor outer mix-blend-difference"
				style={{
			...
			/>
			<div
				className="cursor inner mix-blend-difference"
				style={{
					left: `${position.x}px`,
					top: `${position.y}px`,
					width: `${innerSize}px`,
